...
// Night v4l2-ctl --set-ctrl=exposure_dynamic_framerate=20 --set-ctrl=scene_mode=8
// Day   v4l2-ctl --set-ctrl=exposure_dynamic_framerate=20 --set-ctrl=scene_mode=0
// https://picamera.readthedocs.io/en/release-1.13/fov.html
// for nighttime 640x480 and 1280x720 only seem to work.
// https://www.raspberrypi.org/forums/viewtopic.php?f=43&t=62364&start=250

#define PROGNAME        "jcamsyscamerarpi"
#define VERSION 	"0.4"


// RPI GPIO definitons
#define LED		4
#define IRCUT		5			// H=Daylight
#define LIGHTIN		26
...
int read_rpi_serialnumber(char *sn)
{
	int i=0;
	char s[256];
	char line[256]; 
...
//JA
read_rpi_serialnumber((char*)&id);
strcpy(registration.id,id);
