...
extern FD_camerasettings   *fd_camerasettings;
extern FD_serversettings   *fd_serversettings;
...
create_form_main( void )
{
	...
	fl_set_object_boxtype( obj, FL_NO_BOX );
        ...
        fl_addto_tabfolder(obj,"SERVER-SETTINGS",fd_serversettings->serversettings);
